        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">WebCraft Pro</span>
            </div>
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={() => scrollToSection('testimonials')} className="text-gray-600 hover:text-blue-600 transition-colors">
                Depoimentos
              </button>
              <button onClick={() => scrollToSection('faq')} className="text-gray-600 hover:text-blue-600 transition-colors">
                FAQ
              </button>
              <Button onClick={() => scrollToSection('cta')} className="bg-blue-600 hover:bg-blue-700">
                Começar Agora
              </Button>
            </nav>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white border-t border-gray-200">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <Button onClick={() => scrollToSection('cta')} className="w-full mt-2 bg-blue-600 hover:bg-blue-700">
                  Começar Agora
                </Button>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Criamos seu site profissional com hospedagem gratuita, email profissional incluso e suporte dedicado. 
              Tudo que você precisa para ter presença online de qualidade.
            </p>
            <Button 
              size="lg" 
              onClick={() => scrollToSection('pricing')}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Oferecemos tudo que você precisa para ter um site profissional online
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <CardDescription className="text-gray-600">
                  Sites profissionais a partir de apenas R$19/mês. Sem custos ocultos ou surpresas.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <CardDescription className="text-gray-600">
                  Hospedagem moderna e escalável inclusa. Seu site sempre online e rápido.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <CardDescription className="text-gray-600">
                  1 conta de email profissional gratuita inclusa para dar credibilidade ao seu negócio.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <CardDescription className="text-gray-600">
                  Entrega rápida e suporte dedicado sempre que você precisar. Estamos aqui para ajudar.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
      ...
      <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Escolha o plano ideal para o seu negócio. Todos incluem hospedagem e email gratuitos.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="relative group hover:shadow-xl transition-all duration-300">
              <CardHeader className="text-center">
                ...
                <CardDescription className="mt-2">Perfeito para começar</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span>1 site profissional</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
            ...
            <Card className="relative group hover:shadow-xl transition-all duration-300 border-2 border-blue-600">
              ...
              <CardHeader className="text-center">
                ...
                <CardDescription className="mt-2">Para negócios em crescimento</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
            ...
            <Card className="relative group hover:shadow-xl transition-all duration-300">
              <CardHeader className="text-center">
                ...
                <CardDescription className="mt-2">Para empresas estabelecidas</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                ...
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span>Hospedagem enterprise</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
      ...
      <section id="testimonials" className="py-20 bg-gray-50 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Mais de 1.000 empresas confiam na WebCraft Pro para sua presença online
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 mb-4">
                  "A WebCraft Pro transformou completamente nossa presença online. O site ficou incrível e o suporte é excepcional!"
                </p>
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">CEO, Boutique Elegance</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 mb-4">
                  "Excelente custo-benefício! Nosso restaurante agora tem um site profissional que atrai muitos clientes."
                </p>
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">Proprietário, Sabor & Arte</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 mb-4">
                  "Processo super rápido e fácil. Em poucos dias tínhamos nosso site no ar com email profissional funcionando."
                </p>
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">Diretora, Tech Solutions</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                Após a contratação, nossa equipe entrará em contato em até 24h para entender suas necessidades. 
                Criamos o site em até 7 dias úteis e você pode solicitar ajustes durante o processo. 
                Após aprovação, seu site fica online imediatamente.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                O plano básico inclui: 1 site profissional responsivo, hospedagem gratuita, 1 conta de email profissional, 
                SSL gratuito, suporte básico e todas as atualizações de segurança. O domínio é pago separadamente pelo cliente.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                Nossos contratos têm duração mínima de 1 ano. Após este período, você pode cancelar a qualquer momento 
                com 30 dias de antecedência. Durante o período de contrato, oferecemos garantia de satisfação.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent>
                Configuramos seu email profissional (ex: seu-nome@seudominio.com.br) que pode ser acessado via webmail, 
                Outlook, Gmail ou qualquer cliente de email. Inclui 1GB de armazenamento no plano básico, 
                com opções de upgrade disponíveis.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent>
                Sim, o domínio é pago separadamente pelo cliente. Podemos ajudar na escolha e registro do domínio, 
                que custa em média R$40/ano para .com.br. Isso garante que o domínio seja de sua propriedade total.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      ...
      <section id="cta" className="py-20 bg-blue-600 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Junte-se a mais de 1.000 empresas que já transformaram sua presença online conosco. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Criamos sites profissionais com hospedagem gratuita, email profissional e suporte dedicado. 
                Sua presença online de qualidade começa aqui.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><button onClick={() => scrollToSection('benefits')} className="hover:text-white transition-colors">Benefícios</button></li>
